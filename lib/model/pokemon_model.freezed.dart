...
mixin _$PokemonModel {
  PokemonFrontModel get sprites => throw _privateConstructorUsedError;
...
abstract class $PokemonModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({PokemonFrontModel sprites});

  $PokemonFrontModelCopyWith<$Res> get sprites;
}
...
class _$PokemonModelCopyWithImpl<$Res, $Val extends PokemonModel>
  ...
  @pragma('vm:prefer-inline')
  $PokemonFrontModelCopyWith<$Res> get sprites {
    return $PokemonFrontModelCopyWith<$Res>(_value.sprites, (value) {
...
class _$_PokemonModel implements _PokemonModel {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, sprites);
...
abstract class _PokemonModel implements PokemonModel {
  const factory _PokemonModel({required final PokemonFrontModel sprites}) =
      _$_PokemonModel;
